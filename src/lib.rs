...
#[derive(Debug)]
pub struct BashHelperProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BashHelperProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BashHelper processing");
    
    let mut processor = BashHelperProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BashHelperProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BashHelperProcessor::new(false);
